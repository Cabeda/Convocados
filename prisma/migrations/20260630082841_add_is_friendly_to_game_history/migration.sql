...
INSERT INTO "new_GameHistory" ("createdAt", "dateTime", "editableUntil", "eloProcessed", "eventId", "id", "paymentsSnapshot", "scoreOne", "scoreTwo", "source", "status", "teamOneName", "teamTwoName", "teamsSnapshot") SELECT "createdAt", "dateTime", "editableUntil", "eloProcessed", "eventId", "id", "paymentsSnapshot", "scoreOne", "scoreTwo", "source", "status", "teamOneName", "teamTwoName", "teamsSnapshot" FROM "GameHistory";
