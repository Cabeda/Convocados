...
INSERT INTO "new_Event" ("accessPassword", "allowManualRating", "archivedAt", "balanced", "courtWatchConfig", "createdAt", "currentGameId", "dateTime", "durationMinutes", "eloEnabled", "hideEloInTeams", "id", "isPublic", "isRecurring", "latitude", "location", "longitude", "maxPlayers", "mvpEloEnabled", "mvpEnabled", "nextResetAt", "notificationDefaults", "ownerId", "paymentEnforcementLevel", "paymentGateThreshold", "priorityDeadlineHours", "priorityEnabled", "priorityMaxPercent", "priorityMinGames", "priorityThreshold", "priorityWindow", "recurrenceRule", "rsvpCutoffSent", "showCompetitiveData", "showDebtorNames", "splitCostsEnabled", "sport", "teamOneName", "teamTwoName", "timezone", "title", "updatedAt") SELECT "accessPassword", "allowManualRating", "archivedAt", "balanced", "courtWatchConfig", "createdAt", "currentGameId", "dateTime", "durationMinutes", "eloEnabled", "hideEloInTeams", "id", "isPublic", "isRecurring", "latitude", "location", "longitude", "maxPlayers", "mvpEloEnabled", "mvpEnabled", "nextResetAt", "notificationDefaults", "ownerId", "paymentEnforcementLevel", "paymentGateThreshold", "priorityDeadlineHours", "priorityEnabled", "priorityMaxPercent", "priorityMinGames", "priorityThreshold", "priorityWindow", "recurrenceRule", "rsvpCutoffSent", "showCompetitiveData", "showDebtorNames", "splitCostsEnabled", "sport", "teamOneName", "teamTwoName", "timezone", "title", "updatedAt" FROM "Event";
DROP TABLE "Event";
