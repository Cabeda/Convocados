...
INSERT INTO "new_GameHistory" ("createdAt", "dateTime", "eloProcessed", "eventId", "id", "isFriendly", "paymentsSnapshot", "scoreOne", "scoreTwo", "source", "status", "teamOneName", "teamTwoName", "teamsSnapshot") SELECT "createdAt", "dateTime", "eloProcessed", "eventId", "id", "isFriendly", "paymentsSnapshot", "scoreOne", "scoreTwo", "source", "status", "teamOneName", "teamTwoName", "teamsSnapshot" FROM "GameHistory";
