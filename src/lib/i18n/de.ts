...
const de: TranslationKeys = {
  ...
  addHistoricalGame: "Vergangenes Spiel hinzufügen",
  addHistoricalGameDesc: "Ein Spiel aus der Vergangenheit aufzeichnen. Die ELO-Wertung wird nicht automatisch berechnet — du kannst sie später genehmigen.",
  historicalGame: "Vergangenes Spiel",
  ...
  player: "Spieler",
  createPastGame: "Vergangenes Spiel aufzeichnen",
  creatingPastGame: "Wird aufzeichnet...",
  addPastGameSuccess: "Vergangenes Spiel erfolgreich aufzeichnet!",
  errorCreatingPastGame: "Fehler beim Aufzeichnen des vergangenen Spiels.",
