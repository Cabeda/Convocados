...
const en = {
  ...
  settleOutstandingTotal: "Total outstanding",
  settleOutstandingSummary: "{games} pending payment(s) across {players} player(s)",
  settleSourceLabel: "Source",
  settleGamesLabel: "games",
  settlePlayersLabel: "players",
  settleMissingPlayers: "missing player(s)",
  settlePlayerHeader: "Player",
  settleAmountHeader: "Amount",
  settleStatusHeader: "Status",
  settleActionsHeader: "Actions",
  settleStatusPending: "pending",
  settleStatusSent: "sent",
  settleMarkPaid: "Mark paid",
  settleRemindAction: "Send payment reminder",
  settleMarkAllPaid: "Mark all paid",
  settleBulkTitle: "Settle all debts for a player",
  settleAllClear: "All caught up. No outstanding payments across any game.",
  settleMatrixTitle: "Payments matrix",
  settleMatrixHelp: "Each cell shows a game payment. Green ✓ = settled, blank = not in this game.",
  settleMatrixPlayerHeader: "Player",
  settleSettledAt: "Settled {when}",
  settlePaidBy: "Paid by {payer}",
  settlePaidTo: "Paid to {receiver}",
  settleDialogTitle: "Mark as paid",
  settleDialogBody: "{player} owes {amount} for this game.",
  settleBulkDialogTitle: "Mark all debts as settled",
  settleBulkDialogBody: "{player} owes {amount} across {games} games. Mark all as settled?",
  settleFieldMethod: "Method",
  settleFieldPayer: "Paid by",
  settleFieldPaidTo: "Paid to",
  settleMethodCash: "Cash",
  settleMethodMbway: "MB Way",
  settleMethodRevolut: "Revolut",
  settleMethodTransfer: "Bank transfer",
  ...
  paymentsPrice: "{amount} {currency}/player",
  paymentsPricePreview: "~{amount} {currency}/player",
  paymentsPerPlayer: "{amount} {currency}/player · {total} players",
  paymentsPerPlayerPreview: "~{amount} {currency}/player (max {max})",
  paymentsYouOwe: "You owe {amount} {currency}",
  paymentsViewAll: "View payments",
  paymentsWhoLabel: "Who paid",
  paymentMethodPayerDirect: "Each player pays directly to the court",
  paymentMethodCashInstruction: "Bring {amount} {currency} cash to the game",
  paymentOverrideTitle: "Change payment method",
  paymentOverrideDefaultTitle: "Event payment method",
  paymentOverrideGameTitle: "Payment method for this game",
  paymentOverrideDesc: "Set how players should pay for this game. One-off changes apply to this week only and reset after the game.",
  paymentOverrideChange: "Change payment method",
  paymentOverrideActive: "Payment method changed (one-off)",
  paymentOverrideSetDefault: "Set as default for all future games",
  paymentOverrideSetDefaultDesc: "Replaces the permanent payment method. One-off override will be cleared.",
  paymentOverrideOneOffNote: "This change applies to this game only. The organiser can update the default in settings.",
  paymentOverrideSaveOneOff: "Apply for this game",
  paymentOverrideSaveDefault: "Save as default",
  paymentOverrideSaveGame: "Save for this game",
  paymentOverrideMissingGameId: "A game is required for a per-game override.",
  paymentOverrideEmptyError: "Add at least one payment method.",
  ...
  postGameMarkPaidHint: "Tap to mark {player} as paid",
  postGamePaidHint: "{player} has paid",
  postGameTapToPayHint: "Open Settle to mark as paid",
  ...
  settleTabPayments: "Payments",
  paymentsMatrixTitle: "By game",
  paymentsMatrixNoGames: "No played games yet. The matrix will populate after the first game is played.",
  paymentsMatrixSource: "Source",
  paymentsMatrixTotalGames: "{n} games",
  paymentsMatrixTotalPlayers: "{n} players",
  paymentsMatrixPlayerHeader: "Player",
  paymentsMatrixTotalHeader: "Total",
  paymentsMatrixSettleTitle: "Mark as paid?",
  paymentsMatrixSettleBody: "Mark {player}'s payment for this game as paid?",
  paymentsMatrixSettleConfirm: "Mark paid",
  playerDebtsTitle: "By player",
  playerDebtsAllClear: "No outstanding debts. Everyone is paid up. 🎉",
  playerDebtsIntro: "{n} player(s) with outstanding debts",
  playerDebtsRemindAction: "Send payment reminder",
  playerDebtsMarkAllPaid: "Mark all paid",
  playerDebtsGameHeader: "Game",
  playerDebtsAmountHeader: "Amount",
  playerDebtsStatusHeader: "Status",
  playerDebtsPending: "pending",
  playerDebtsBulkTitle: "Mark all debts as settled?",
  playerDebtsBulkBody: "Mark all of {player}'s outstanding historical payments as paid?",
  paymentsManageLink: "Manage all payments →",
  ...
  settleHeroShouldPay: "should pay",
  settleHeroAllSettled: "All settled — nobody owes anything.",
  settleHeroAriaLabel: "Net positions",
  settleHeroOwes: "owes",
  settleHeroIsOwed: "is owed",
  settleHeroLegendDebtor: "Brown = owes",
  settleHeroLegendCreditor: "Green = is owed",
  settleHeroTransactions: "Transactions",
  settleHeroMembers: "Members",
  settleHeroTotalSpent: "Total spent",
  settleHeroShowCharts: "Show charts",
  settleHeroChangeMethod: "Change method",
  settleHeroExportCsv: "Export CSV",
  settleHeroRecompute: "Recompute balances",
  settleTabTransactionsHint: "Detailed payments live in the game history for each game. Open a past game to see who paid what.",
  settleDebtsTitle: "Debts",
  settleDebtsAllClear: "All caught up. Nobody owes anything.",
  settleDebtsActionMarkSettled: "Mark debt as settled",
  settleDebtsActionRemind: "Remind {name}",
  settleDebtsActionGenerateQr: "Generate QR payment",
  settleTxnsFilterAll: "All",
  settleTxnsFilterGames: "Games",
  settleTxnsFilterSubs: "Subscriptions",
  settleTxnsFilterSpends: "Spends",
  settleTxnsAddButton: "Add transaction",
  settleTxnsEmptyNone: "No transactions yet. Add a subscription or a one-off spend to get started.",
  settleTxnsEmptyFiltered: "No transactions match the selected filter.",
  addTxnTitle: "Add transaction",
  addTxnTypeSubscription: "Subscription",
  addTxnTypeSpend: "One-off spend",
  addTxnPickPlayer: "Pick a player",
  addTxnNoUsers: "No players in this event yet.",
  addTxnNoUser: "Pick a player first.",
  addTxnNoLabel: "Enter a label for the spend.",
  addTxnInvalidAmount: "Enter a positive amount.",
  addTxnLabel: "Label (e.g. Bought balls)",
  addTxnAmount: "Amount",
  addTxnSaveSubscription: "Add subscription",
  addTxnSaveSpend: "Add spend",
  extrasCatLabel: "Category",
  extrasCatCourtRental: "Court rental",
  extrasCatEquipment: "Equipment",
  extrasCatRefreshments: "Refreshments",
  extrasCatAdmin: "Admin",
  extrasReceiptUrlLabel: "Receipt URL (optional)",
  extrasAllocLabel: "Allocation",
  extrasAllocOrganizer: "Organizer absorbs",
  extrasAllocOrganizerDesc: "Organizer pays; no player charges",
  extrasAllocToPlayers: "Allocate to players",
  extrasAllocToPlayersDesc: "Specify exact cents per player",
  extrasAllocSplitEqually: "Split equally",
  extrasAllocSplitEquallyDesc: "Divide evenly among active players",
  extrasAllocSharesLabel: "Shares per player (cents)",
  settleTxnRowEdit: "Edit",
  settleTxnRowDelete: "Delete",
  settleTxnDeleteTitle: "Delete this transaction?",
  settleTxnDeleteConfirm: "This will permanently remove the transaction. It cannot be undone.",
  settleTxnDeleteAction: "Delete",
  settleTxnDeleteCancel: "Cancel",
  settleMarkSettledNetworkError: "Network error. Please try again.",
  settleMarkSettledNoPermission: "Only the event owner or the creditor can mark this debt as settled.",
  settleMarkSettledFailed: "Could not mark the debt as settled.",
  settleMarkSettledSuccess: "Settled {settled} payment(s) for {name} (skipped {skipped}, failed {failed}).",
  settleMarkSettledAlready: "{name}'s debts were already settled.",
  settleMarkSettledAllFailed: "Could not settle {name}'s debts ({failed} failed).",
  settleTxnsFilterSettlements: "Settlements",
  settleTabTransactions: "Transactions",
  settleTabDebts: "Debts",
  settleTabMembers: "Members",
  settleTabPermissions: "Permissions",
  settleTabRecentActivity: "Recent activity",
