...
const en = {
  ...
  addLocationInline: "Add location",
  addCostInline: "Add cost",
  ...
  inviteYouAreIn: "You're on the list as {name}",
  inviteGuestNote: "No account needed — add one anytime to keep your history and get reminders.",
  inviteNoAccountNeeded: "No account needed — accept as a guest and add one later.",
  inviteJoinAsViewer: "Join as {name}",
  inviteJoinAsGuest: "Join as {name} (guest)",
  inviteClaimTitle: "Keep your spot forever",
  inviteClaimDesc: "Bind this spot to an account so your games, ratings and reminders follow you.",
  inviteClaimBind: "This is me",
  inviteClaimGoogle: "Continue with Google",
  inviteClaimEmailPlaceholder: "your@email.com",
  inviteClaimEmailCta: "Email me a link",
  inviteClaimEmailSent: "Link sent — check your inbox to finish setting up your account.",
  ...
  movePlayerToTeam: "Move to {team}",
  decreaseScore: "Decrease {team} score",
  increaseScore: "Increase {team} score",
  ...
  crewLeague: "Crew league",
  allGames: "All games",
  leaderboardGames: "{n} games counted",
  ...
  leaderboardGoalsAgainst: "GA",
  leaderboardGoalDifference: "GD",
  leaderboardRounds: "Rounds",
  leaderboardNoCrews: "No Crew standings are available for this scope.",
  leaderboardNoGames: "No completed competitive games in this scope.",
  leaderboardHidden: "Competitive standings are hidden for this event.",
  leaderboardScope: "Competition",
  seasonRankTitle: "Season Rank",
  seasonRankSubtitle: "Friendly games don't affect Rank · {n} qualifying games",
  seasonRankTier: "Tier",
  seasonRankRank: "Rank",
  seasonRankProgress: "Progress to next",
  seasonRankProvisional: "Provisional",
  seasonRankUnlocks: "unlocks at 3 games ({n}/3)",
  seasonRankTopTier: "Top tier",
  seasonRankToNext: "{n} to {tier}",
  tierUpTitle: "You reached {tier}!",
  tierUpBody: "Earned on the pitch this season — not a prize, just your form.",
  tierDownTitle: "New season, fresh start",
  tierDownBody: "Your Rank soft-reset. You're back in {tier} — climb again.",
  seasonRankHowItWorks: "How Rank works",
  postGameRankStandingTitle: "Rank Standing",
  postGameRankUpdatedTitle: "Rank Updated",
  postGameRankDelta: "{delta} RP",
  postGameRankUnlock: "Rank unlocks at 3 games — {n}/3",
  postGameRankTierUp: "Tier up — you're now {tier}",
  postGameRankToNext: "{n} RP to {tier}",
  postGameRankWhy: "How rank works",
  postGameRankWhyAria: "How season rank works",
  postGameRankCue: "This game updates your Rank — enter the score first",
  postGameRankViewSeason: "View season",
  postGameRankViewSeasonAria: "Open {season} on the Season page",
  postGameRankDismiss: "Dismiss Rank",
  postGameRankCrewLabel: "Crew",
  postGameRankCrewPlace: "#{place} of {total}",
  postGameRankCrewPoints: "{n} pts",
  postGameRankCrewPointsDelta: "+{n} pts",
  rankExplainerTitle: "How your Rank was calculated",
  rankExplainerIntro: "Season Rank is earned on the pitch: each counted game pays Rank Points (RP), and friendly games don't count. Here are the exact numbers behind this game — change them to see how the payout moves.",
  rankExplainerInputsTitle: "Your inputs",
  rankExplainerRankAfter: "Rank after the game",
  rankExplainerDelta: "Rank change",
  rankExplainerOutcome: "Result",
  rankExplainerOpponent: "Opponent average",
  rankExplainerOutcomeWin: "Win",
  rankExplainerOutcomeDraw: "Draw",
  rankExplainerOutcomeLoss: "Loss",
  rankExplainerTierNote: "You're in {tier}.",
  rankExplainerShareNote: "Share this link to show exactly how your score was calculated.",
  rankExplainerDocsLink: "Read how Rank works",
  continueAction: "Continue",
  crewBestSixTitle: "Best six of eight game scores",
  crewRoundsTitle: "Games counted / games represented",
  crewGameScores: "Game scores",
  crewTieBreakTotal: "All-games total: {total}",
  crewScoreCounted: "Counts toward the best six",
  crewScoreDropped: "Dropped from the best six",
  ...
  webhookHelp: "Register a URL to receive POST callbacks for player activity. Leave events empty to get all.",
  webhookUrl: "Webhook URL",
  webhookSecret: "Secret (optional)",
  webhookSecretPlaceholder: "Used to sign payloads (HMAC-SHA256)",
  webhookUrlRequired: "Webhook URL is required.",
  webhookInvalidUrl: "That doesn't look like a valid URL.",
  webhookAdd: "Register webhook",
  webhookAddError: "Could not register webhook.",
  webhookNone: "No webhooks registered yet.",
  webhookAllEvents: "all events",
  webhookEventType_player_joined: "Player joined",
  webhookEventType_player_left: "Player left",
  webhookEventType_game_full: "Game full",
  webhookEventType_game_reset: "Game reset",
  webhookEventType_player_invited: "Player invited",
  ...
  webhookDeliveryStatus_failed: "failed",
  webhookDeliveryStatus_pending: "pending",
  ...
  ratingsHidden: "Skill Rating is hidden for this event.",
  ...
  eloExplainer: "Skill Rating updates after each game using the ELO system. You gain more points for beating stronger opponents and lose more for losing to weaker ones. New players' ratings move faster (K=48) until they play 6 games, then stabilize (K=32).",
...
sportBadmintonSingles: "Badminton (singles)",
  sportBadmintonDoubles: "Badminton (doubles)",
  sportSquash: "Squash",
  ...
  upNext: "Up next",
  discover: "Discover",
  manageMyGames: "Manage my games",
  browseAllPublicGames: "Browse all public games",
  noUpcomingGames: "No upcoming games yet.",
  noDiscoverGames: "No public games to join right now.",
  needsYou: "Needs you",
  actionFillSpots: "{n} spot(s) left — invite players",
  actionSettleScore: "Add the score for the last game",
  actionPayShare: "You owe {amount}",
  actionVoteMvp: "Vote for the MVP",
  addGamesPromptTitle: "Add your other games",
  addGamesPromptBody: "Play with another group? Add that game too — share the link and everyone can join.",
  addGamesCta: "Add a game",
  ...
  photoUploadHint: "JPG, PNG or WebP · up to 500 KB",
  photoInvalidType: "Choose a JPG, PNG or WebP image.",
  photoTooLarge: "Image is too large. Maximum 500 KB.",
  ...
  season: "Season",
  seasonSetup: "Crew setup",
  seasonSetupDescription: "Set a starting date, recommend balanced Crews, and adjust them before saving.",
  seasonReadOnlyDescription: "This Season is read-only.",
  seasonNoCrews: "No Crews have been set for this Season.",
  seasonMemberCount: "{n} participants",
  seasons: "Seasons",
  seasonHistoryDescription: "Browse current and past Seasons and their Crews.",
  currentSeasons: "Current seasons",
  pastSeasons: "Past seasons",
  noSeasons: "No Seasons yet.",
  seasonStatusRegistration: "Registration",
  seasonStatusActive: "Active",
  seasonStatusReview: "Under review",
  ...
  seasonPeriodHint: "Pick the registration window. It cannot overlap another season's period.",
  registrationOpensAt: "Registration opens",
  registrationClosesAt: "Registration closes",
  viewLeaderboard: "View leaderboard",
  startSeason: "Start season",
  startingSeason: "Starting…",
  seasonStartTitle: "Start the season",
  seasonActiveTitle: "Season is active",
  seasonStartRequirements: "Ready when there are at least 3 Crews of 3–5 and 9 participants. Now: {crews} Crews, {participants} participants.",
  seasonActiveDescription: "Registration is locked. As an admin you can still adjust Crews if needed.",
  seasonAdminEditDescription: "Registration is locked, but as an admin you can still adjust Crews below.",
  seasonActivateError: "Could not start the season.",
  seasonCompletedTitle: "Season completed",
  seasonCompletedDescription: "Final standings are frozen. Reopen to resume competition.",
  seasonCancelledTitle: "Season cancelled",
  seasonCancelledDescription: "This Season was cancelled and is excluded from standings.",
  completeSeason: "Complete season",
  completingSeason: "Completing…",
  completeSeasonTitle: "Complete this season?",
  completeSeasonConfirm: "Final standings and Season Rank are frozen and the Season becomes read-only. You can reopen it later.",
  seasonCompleteError: "Could not complete the season.",
  reopenSeason: "Reopen season",
  reopeningSeason: "Reopening…",
  reopenSeasonTitle: "Reopen this season?",
  reopenSeasonConfirm: "The Season returns to active and its standings resume changing.",
  seasonReopenError: "Could not reopen the season.",
  seasonReopenBlocked: "Another Season is already active. Complete it before reopening this one.",
  seasonStartDate: "Season starting date",
  crewCount: "Number of Crews",
  recommendCrews: "Recommend Crews",
  recommendingCrews: "Recommending…",
  saveCrews: "Save Season setup",
  savingCrews: "Saving…",
  crewName: "Crew name",
  crewElo: "Crew ELO",
  addCrew: "Add crew",
  seasonCancelError: "Could not cancel the season.",
  cancellingSeason: "Cancelling…",
  keepSeason: "Keep season",
  cancelSeasonReason: "Reason (optional)",
  cancelSeasonConfirm: "The season is cancelled and stays in Past seasons; its period is freed for a new season. Cancelled seasons are excluded from standings.",
  cancelSeasonTitle: "Cancel this season?",
  cancelSeason: "Cancel season",
  crewDeleteError: "Could not delete the Crew.",
  crewDeleted: "Deleted {name}.",
  deletingCrew: "Deleting…",
  deleteCrew: "Delete Crew",
  deleteCrewConfirm: "Delete {name}? Its players stay in the Season as unassigned.",
  deleteCrewTitle: "Delete Crew?",
  deleteCrewAria: "Delete {name}",
  memberRemoved: "Removed {name} from the season.",
  removeMemberFromSeason: "Remove {name} from the season",
  seasonDetailsError: "Could not save the season details.",
  seasonDetailsSaved: "Season details saved.",
  savingDetails: "Saving…",
  saveDetails: "Save details",
  seasonDetails: "Season details",
  playerAddedUnassigned: "Added {name} (unassigned).",
  playerAddedToCrew: "Added {name} to {crew}.",
  noAccountSuffix: "(no account)",
  noMatchingPlayers: "No matching players",
  addPlayer: "Add player",
  addPlayerToCrew: "Add player to {crew}",
  recentPlayersNone: "No players from recent games to add.",
  recentPlayersSkipped: "{skipped} skipped (no account yet: {names}).",
  recentPlayersAdded: "Added {added} players to the season.",
  addingRecentPlayers: "Adding…",
  addRecentPlayers: "Add recent players",
  crewMembers: "Crew members",
  unassigned: "Unassigned",
  crewForMember: "Crew for {name}",
  unassignedPlayers: "Unassigned participants",
  seasonSaved: "Season setup saved.",
  seasonSetupError: "Could not save the Season setup.",
  seasonNoParticipants: "Add at least six active participants before defining Crews.",
  seasonSignInRequired: "Sign in as the event owner or an admin to manage Crews.",
  joinSeason: "Join Season",
  leaveSeason: "Leave Season",
  joiningSeason: "Joining…",
  leavingSeason: "Leaving…",
  seasonMembershipError: "Could not update your Season registration.",
  proposeCrew: "Propose a Crew",
  proposeCrewDescription: "Choose 3–5 Season participants and submit your Crew for admin approval.",
  crewProposalName: "Crew name",
  selectCrewMembers: "Select Crew members",
  submitCrewProposal: "Submit Crew proposal",
  submittingCrewProposal: "Submitting…",
  proposalSubmitted: "Crew proposal submitted for approval.",
  pendingProposals: "Pending Crew proposals",
  crewProposalReviewQueue: "Crew proposal review",
  noPendingProposals: "No pending Crew proposals.",
  approveProposal: "Approve",
  approveProposalFor: "Approve proposal {name}",
  rejectProposal: "Reject",
  rejectProposalFor: "Reject proposal {name}",
  rejectionReason: "Rejection reason (optional)",
  proposalProposedBy: "Proposed by {name}",
  yourProposals: "Your Crew proposals",
  proposalStatusPending: "Pending",
  proposalStatusApproved: "Approved",
  proposalStatusRejected: "Rejected",
  crewProposalError: "Could not load or save the Crew proposal.",
  ...
  mergeConfirmDesc: "This Google sign-in belongs to another Convocados account ({email}, created {date}). Merging moves its data into this account, signs out its other devices, and cannot be undone.",
  mergeConfirmBtn: "Merge accounts",
  mergeCancelBtn: "Cancel",
  mergeSuccess: "Accounts merged.",
  mergeError: "Could not merge accounts.",
  ...
  myNotificationsDescFollower: "You're following this game but not on the player list. Game reminders and player activity are for players only — you'll still get event changes. Join the game to get everything.",
  ...
  notifyThisDeviceTitle: "This device",
  notifyAccountTitle: "Your account",
  notifyDeviceOn: "Notifications are on for this device",
  notifyDeviceOff: "Notifications are off on this device",
  notifyDeviceBlocked: "Notifications are blocked in your browser settings",
  notifyDeviceNeedsInstall: "Add Convocados to your Home Screen to enable notifications",
  notifyDeviceUnsupported: "This browser doesn't support push notifications",
  notifyEnableDevice: "Enable on this device",
  notifyDisableDevice: "Turn off on this device",
  notifyPushEnableFailed: "Couldn't enable notifications on this device. Try again.",
  notifyPushDisableFailed: "Couldn't turn off notifications on this device. Try again.",
  ...
  notifyPlayerInvited: "You've been invited to play in {event}",
  invitePageTitle: "Game invite",
  inviteNotFound: "This invite could not be found.",
  inviteExpired: "This invite has expired.",
  inviteAccepted: "You've joined the game!",
  inviteDeclined: "You declined this invite.",
  inviteCancelled: "This invite was cancelled.",
  inviteSignInCta: "Sign in to view and respond to this invite.",
  inviteSignIn: "Sign in",
  inviteAccept: "Accept",
  invitationsTitle: "Invitations",
  rosterAddedYou: "You were added to",
  invitationsError: "Could not respond. Try again.",
  inviteDeclineBtn: "Decline",
  inviteInvitedBy: "{name} invited you to play",
  inviteWhoIsIn: "Who's already in",
  inviteSpotsLeft: "{n} spots left",
  recurrencePromptTitle: "Same again next week?",
  recurrencePromptBody: "Repeat this game automatically every week — players and teams stay put.",
  recurrenceMakeWeekly: "Make it weekly",
  recurrenceDone: "Repeats weekly",
  recurrenceFailed: "Could not save. Try again.",
  recurrenceWeeklyLabel: "Weekly",
  recurrenceAlreadyOn: "This event repeats every week",
  inviteViewGame: "View game",
  inviteSentVia: "Invite sent to {name} via {channels}",
  inviteNoChannels: "No notifications enabled for {name}",
  inviteNoChannelsDesc: "They won't be notified automatically — share the invite link directly.",
  inviteShareLink: "Share link",
  inviteCopyLink: "Copy link",
  inviteLinkCopied: "Invite link copied",
  channelEmail: "email",
  channelWebPush: "web push",
  channelAppPush: "app notification",
  inviteLinkOnly: "No notification channels — share the link directly",
  inviteLinkOnlyShort: "link only",
  ...
  notifyInviteOptOutDesc: "Pause invites, suggestions and reminder pings for this game. You'll still stay on the player list.",
  receiveGameInvites: "Receive game invites",
  ...
  adminFilterPlatform: "Platform",
  adminFilterAll: "All",
  adminFilterHasToken: "Has token",
  adminFilterNoToken: "No token",
  adminPushPlatform: "Push Platform",
  adminAppVersion: "App Version",
  adminAppVersionTooltip: "App version from native client heartbeat",
...
statsGoals: "Goals",
  ...
  competitiveRankings: "Competitive rankings",
  competitiveRankingsTooltip: "Track skill ratings, balance teams, and run a seasonal Rank ladder",
  competitiveRankingsDesc: "One switch turns on skill ratings, balanced teams, Season Rank, and MVP impact.",
  advancedSettings: "Advanced",
  rankDecay: "Decay Rank for inactive players",
  rankDecayTooltip: "Slowly reduce Rank for players who stop playing. Off by default.",
  inactiveRankBehavior: "When a player is inactive or withdrawn",
  inactiveRankFreeze: "Freeze",
  inactiveRankReset: "Reset",
  ...
  notifyPickupAdopted: "{name} adopted the pickup at {club}",
openPickupBadge: "Open pickup",
  claimPickup: "Claim this pickup",
  claimPickupFailed: "Could not claim this pickup. Try again.",
  claimPickupConfirm: "Take over this pickup and become its owner?",
adminPickupsDetected: "Pickups detected",
  adminPickupsAdopted: "Pickups adopted",
  adminPickupAdoptionRate: "Adoption rate (30d)",
  ...
  postGameResultEyebrow: "Final result",
  postGameShowTasks: "Show tasks",
  ...
  postGameNoScoreYet: "No score yet",
  ...
  // Payments page (payment overhaul)
  paymentsPageTitle: "Payments",
  paymentsIntro: "Who still needs to receive money or pay, across unsettled games.",
  paymentsToReceive: "To receive",
  paymentsToPay: "To pay",
  paymentsNoUnsettled: "Nothing outstanding — every game is settled.",
  paymentsUnsettledGames: "Unsettled games",
  paymentsIsOwed: "{name} is owed {amount}",
  paymentsOwes: "{name} owes {amount}",
  paymentsGameDate: "Game · {date}",
  paymentsMarkPaid: "Mark paid",
  paymentsSettleAll: "Mark all paid",
  paymentsReportSent: "Report sent",
  paymentsConfigTitle: "Who paid this game?",
  paymentsConfigHint: "Choose how this game's cost is settled.",
  paymentsModeTracked: "Someone paid the game",
  paymentsModeUntracked: "Each player pays their own share",
  paymentsPayerPlayer: "A player",
  paymentsPayerExternal: "An external person",
  paymentsPayerExternalPlaceholder: "Name (e.g. venue staff)",
  paymentsSave: "Save",
  ...
  // Play Store listing
  landingBetaButton: "Get the Android app",
  betaBannerTitle: "Convocados on Google Play",
  betaBannerBody: "Install Convocados straight from the Play Store — free, and on your home screen in one tap.",
