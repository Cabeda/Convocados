...
const es: TranslationKeys = {
  ...
  addHistoricalGame: "Añadir juego pasado",
  addHistoricalGameDesc: "Registra un juego que ocurrió en el pasado. El ELO no se calculará automáticamente — puedes aprobarlo después.",
  historicalGame: "Juego pasado",
  ...
  player: "Jugador",
  createPastGame: "Registrar juego pasado",
  creatingPastGame: "Registrando...",
  addPastGameSuccess: "¡Juego pasado registrado con éxito!",
  errorCreatingPastGame: "Error al registrar juego pasado.",
