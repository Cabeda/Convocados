...
const fr: TranslationKeys = {
  ...
  addHistoricalGame: "Ajouter un match passé",
  addHistoricalGameDesc: "Enregistre un match qui a eu lieu dans le passé. L'ELO ne sera pas calculé automatiquement — tu peux l'approuver après.",
  historicalGame: "Match passé",
  ...
  player: "Joueur",
  createPastGame: "Enregistrer le match passé",
  creatingPastGame: "Enregistrement...",
  addPastGameSuccess: "Match passé enregistré avec succès!",
  errorCreatingPastGame: "Échec de l'enregistrement du match passé.",
