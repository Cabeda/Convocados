...
const pt: TranslationKeys = {
  ...
  addPlayerOrEmailHelper: "Escreve um nome para adicionar, ou um email para convidar — notifica-os se estiverem no Convocados, senão envia um convite por email",
  ...
  addPlayerConfirmTitle: "Adicionar {name}?",
  addPlayerConfirmDesc: "Isto adiciona {name} à lista de jogadores de {eventName}.",
  addPlayerConfirmDescEmail: "Isto adiciona {name} à lista de jogadores de {eventName}. Será enviado um convite por email para {email}.",
  addPlayerConfirmDescBench: "Isto adiciona {name} à lista de jogadores de {eventName}. O plantel está cheio — {name} será adicionado ao banco.",
  addPlayerConfirmDescBoth: "Isto adiciona {name} à lista de jogadores de {eventName}. Será enviado um convite por email para {email}. O plantel está cheio — {name} será adicionado ao banco.",
  addPlayerConfirm: "Adicionar jogador",
  ...
  notifyPaymentReminder: "💸 Aviso: ainda tens pagamento em falta para {title} — toca para pagar",

  // Settle page — payments UX (ADR 0019 rev)
  settleOutstandingTotal: "Total em dívida",
  settleOutstandingSummary: "{games} pagamento(s) pendente(s) em {players} jogador(es)",
  settleSourceLabel: "Origem",
  settleGamesLabel: "jogos",
  settlePlayersLabel: "jogadores",
  settleMissingPlayers: "jogador(es) em falta",
  settlePlayerHeader: "Jogador",
  settleAmountHeader: "Valor",
  settleStatusHeader: "Estado",
  settleActionsHeader: "Ações",
  settleStatusPending: "pendente",
  settleStatusSent: "enviado",
  settleMarkPaid: "Marcar pago",
  settleRemindAction: "Enviar lembrete de pagamento",
  settleMarkAllPaid: "Marcar tudo pago",
  settleBulkTitle: "Saldar todas as dívidas de um jogador",
  settleAllClear: "Tudo em dia. Sem pagamentos em falta em nenhum jogo.",
  settleMatrixTitle: "Matriz de pagamentos",
  settleMatrixHelp: "Cada célula mostra um pagamento de jogo. ✓ verde = liquidado, vazio = não participou.",
  settleMatrixPlayerHeader: "Jogador",
  settleSettledAt: "Liquidado a {when}",
  settlePaidBy: "Pago por {payer}",
  settlePaidTo: "Pago a {receiver}",
  settleDialogTitle: "Marcar como pago",
  settleDialogBody: "{player} deve {amount} neste jogo.",
  settleBulkDialogTitle: "Saldar todas as dívidas",
  settleBulkDialogBody: "{player} deve {amount} em {games} jogos. Saldar tudo?",
  settleFieldMethod: "Método",
  settleFieldPayer: "Pago por",
  settleFieldPaidTo: "Pago a",
  settleMethodCash: "Dinheiro",
  settleMethodMbway: "MB Way",
  settleMethodRevolut: "Revolut",
  settleMethodTransfer: "Transferência bancária",
  ...
  paymentsPrice: "{amount} {currency}/jogador",
  paymentsPricePreview: "~{amount} {currency}/jogador",
  paymentsPerPlayer: "{amount} {currency}/jogador · {total} jogadores",
  paymentsPerPlayerPreview: "~{amount} {currency}/jogador (máx. {max})",
  paymentsYouOwe: "Deves {amount} {currency}",
  paymentsViewAll: "Ver pagamentos",
  paymentsWhoLabel: "Quem pagou",
  paymentMethodPayerDirect: "Cada jogador paga diretamente ao campo",
  paymentMethodCashInstruction: "Traz {amount} {currency} em dinheiro para o jogo",
  paymentOverrideTitle: "Alterar método de pagamento",
  paymentOverrideDesc: "Define como os jogadores devem pagar este jogo. Alterações pontuais aplicam-se só a esta semana e são repostas após o jogo.",
  paymentOverrideChange: "Alterar método de pagamento",
  paymentOverrideActive: "Método de pagamento alterado (pontual)",
  paymentOverrideSetDefault: "Definir como padrão para todos os jogos",
  paymentOverrideSetDefaultDesc: "Substitui o método de pagamento permanente. A substituição pontual será limpa.",
  paymentOverrideOneOffNote: "Esta alteração aplica-se apenas a este jogo. O organizador pode atualizar o padrão nas definições.",
  paymentOverrideSaveOneOff: "Aplicar para este jogo",
  paymentOverrideSaveDefault: "Guardar como padrão",
  paymentOverrideSaveGame: "Guardar para este jogo",
  paymentOverrideMissingGameId: "É preciso um jogo para uma sobreposição por jogo.",
  paymentOverrideDefaultTitle: "Método de pagamento do evento",
  paymentOverrideGameTitle: "Método de pagamento deste jogo",
  paymentOverrideEmptyError: "Adiciona pelo menos um método de pagamento.",
  ...
  headerNextGameCost: "{per} {currency} / jogador",
  headerNextGameCostTotal: "Custo total do jogo: {total} {currency}",
  ...
  postGameMarkPaidHint: "Toca para marcar {player} como pago",
  postGamePaidHint: "{player} já pagou",
  postGameTapToPayHint: "Abre Pagamentos para marcar como pago",
  ...
  settleTabHistory: "Histórico",
  settlePaymentsMethodTitle: "Método de pagamento",
  settlePaymentsMethodChange: "Alterar método",
  settleHistoryEmpty: "Ainda não há jogos anteriores.",
  settleTabSettle: "Receber",
  settleTabActivity: "A tua atividade",
  settleTabExtras: "Extras",
  settleTabPayments: "Pagamentos",
  paymentsMatrixTitle: "Por jogo",
  paymentsMatrixNoGames: "Ainda sem jogos disputados. A matriz aparece após o primeiro jogo.",
  paymentsMatrixSource: "Origem",
  paymentsMatrixTotalGames: "{n} jogos",
  paymentsMatrixTotalPlayers: "{n} jogadores",
  paymentsMatrixPlayerHeader: "Jogador",
  paymentsMatrixTotalHeader: "Total",
  paymentsMatrixSettleTitle: "Marcar como pago?",
  paymentsMatrixSettleBody: "Marcar o pagamento de {player} neste jogo como pago?",
  paymentsMatrixSettleConfirm: "Marcar pago",
  playerDebtsTitle: "Por jogador",
  playerDebtsAllClear: "Sem dívidas em aberto. Toda a gente está em dia. 🎉",
  playerDebtsIntro: "{n} jogador(es) com dívidas em aberto",
  playerDebtsRemindAction: "Enviar lembrete de pagamento",
  playerDebtsMarkAllPaid: "Marcar tudo pago",
  playerDebtsGameHeader: "Jogo",
  playerDebtsAmountHeader: "Valor",
  playerDebtsStatusHeader: "Estado",
  playerDebtsPending: "pendente",
  playerDebtsBulkTitle: "Marcar todas as dívidas como pagas?",
  playerDebtsBulkBody: "Marcar todos os pagamentos históricos em aberto de {player} como pagos?",
  paymentsManageLink: "Gerir todos os pagamentos →",
  ...
  settleHeroShouldPay: "deve pagar",
  settleHeroAllSettled: "Tudo em dia — ninguém deve nada.",
  settleHeroAriaLabel: "Posições líquidas",
  settleHeroOwes: "deve",
  settleHeroIsOwed: "é devido",
  settleHeroLegendDebtor: "Castanho = deve",
  settleHeroLegendCreditor: "Verde = é devido",
  settleHeroTransactions: "Transações",
  settleHeroMembers: "Membros",
  settleHeroTotalSpent: "Total gasto",
  settleHeroShowCharts: "Mostrar gráficos",
  settleHeroChangeMethod: "Alterar método",
  settleHeroExportCsv: "Exportar CSV",
  settleHeroRecompute: "Recalcular saldos",
  settleTabTransactionsHint: "Os pagamentos detalhados estão no histórico de cada jogo. Abre um jogo passado para ver quem pagou o quê.",
  settleDebtsTitle: "Dívidas",
  settleDebtsAllClear: "Tudo em dia. Ninguém deve nada.",
  settleDebtsActionMarkSettled: "Marcar dívida como paga",
  settleDebtsActionRemind: "Lembrar {name}",
  settleDebtsActionGenerateQr: "Gerar pagamento por QR",
  settleTxnsFilterAll: "Todos",
  settleTxnsFilterGames: "Jogos",
  settleTxnsFilterSubs: "Subscrições",
  settleTxnsFilterSpends: "Despesas",
  settleTxnsFilterSettlements: "Liquidações",
  settleTxnsAddButton: "Adicionar transação",
  settleTxnsEmptyNone: "Ainda sem transações. Adiciona uma subscrição ou uma despesa.",
  settleTxnsEmptyFiltered: "Nenhuma transação corresponde ao filtro.",
  addTxnTitle: "Adicionar transação",
  addTxnTypeSubscription: "Subscrição",
  addTxnTypeSpend: "Despesa pontual",
  addTxnPickPlayer: "Escolhe um jogador",
  addTxnNoUsers: "Ainda não há jogadores neste evento.",
  addTxnNoUser: "Escolhe primeiro um jogador.",
  addTxnNoLabel: "Indica uma descrição para a despesa.",
  addTxnInvalidAmount: "Indica um valor positivo.",
  addTxnLabel: "Descrição (ex.: Bolas)",
  addTxnAmount: "Valor",
  addTxnSaveSubscription: "Adicionar subscrição",
  addTxnSaveSpend: "Adicionar despesa",
  extrasCatLabel: "Categoria",
  extrasCatCourtRental: "Aluguer de campo",
  extrasCatEquipment: "Equipamento",
  extrasCatRefreshments: "Refrescos",
  extrasCatAdmin: "Admin",
  extrasReceiptUrlLabel: "URL do recibo (opcional)",
  extrasAllocLabel: "Distribuição",
  extrasAllocOrganizer: "Organizador paga",
  extrasAllocOrganizerDesc: "Organizador paga; sem cobranças aos jogadores",
  extrasAllocToPlayers: "Distribuir aos jogadores",
  extrasAllocToPlayersDesc: "Especificar cêntimos exatos por jogador",
  extrasAllocSplitEqually: "Dividir igualmente",
  extrasAllocSplitEquallyDesc: "Dividir por igual entre jogadores ativos",
  extrasAllocSharesLabel: "Partes por jogador (cêntimos)",
  settleTxnRowEdit: "Editar",
  settleTxnRowDelete: "Eliminar",
  settleTxnDeleteTitle: "Eliminar esta transação?",
  settleTxnDeleteConfirm: "Esta ação remove permanentemente a transação. Não pode ser revertida.",
  settleTxnDeleteAction: "Eliminar",
  settleTxnDeleteCancel: "Cancelar",
  settleMarkSettledNoPermission: "Só o organizador do evento pode fazer isto.",
  settleMarkSettledFailed: "Não foi possível marcar a dívida como paga.",
  settleMarkSettledSuccess: "Marcadas {settled} dívida(s) de {name} como pagas (ignoradas {skipped}, falhadas {failed}).",
  settleMarkSettledAlready: "As dívidas de {name} já estavam pagas.",
  settleMarkSettledAllFailed: "Não foi possível liquidar as dívidas de {name} ({failed} falhadas).",
  settleMarkSettledNetworkError: "Erro de rede. Tenta novamente.",
  settleTabTransactions: "Transações",
  settleTabDebts: "Dívidas",
  settleTabMembers: "Membros",
  settleTabPermissions: "Permissões",
  settleTabRecentActivity: "Atividade recente",
